...
/***/ 74:
/*!****************************************************************************!*\
  !*** D:/workspace/物业服务前台V1.0.0/main.js?{"page":"pages%2Fdetail%2Fdetail"} ***!
  \****************************************************************************/
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/detail/detail.vue */ 75));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 75:
/*!*********************************************************!*\
  !*** D:/workspace/物业服务前台V1.0.0/pages/detail/detail.vue ***!
  \*********************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_template_id_3e159eb4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3e159eb4& */ 76);
...
/***/ 76:
/*!****************************************************************************************!*\
  !*** D:/workspace/物业服务前台V1.0.0/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \****************************************************************************************/
...
/***/ 78:
/*!**********************************************************************************!*\
  !*** D:/workspace/物业服务前台V1.0.0/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 79:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/workspace/物业服务前台V1.0.0/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* *
 *评论页面
 * */var _default = { data: function data() {return { data: {}, detailDec: '', text: '', id: '', showlogin: false, replylist: [], fetchPageNum: 1, openid: '', token: '', userinfo: '', loading: true };}, onShow: function onShow() {this.checkstat();this.fetchPageNum = 1;this.getData(this.id);}, onLoad: function onLoad(e) {// e.data为获取的字符串
    // data 为传递来的笑话数据结构
    this.id = e.id;var self = this;uni.getStorage({ key: 'detail-' + this.id, success: function success(res) {self.data = (0, _util.parGetData)(res.data);var title = self.data.text;if (title) {title = title.replace(/<*?>/gi, '').substr(0, 12);self.detailDec = title;uni.setNavigationBarTitle({ title: title });}}, complete: function complete() {this.loading = false;} });}, onShareAppMessage: function onShareAppMessage() {return { title: this.detailDec ? this.detailDec : '最新最好笑的趣事趣图，来看下吧', path: '/pages/detail/detail?id=' + this.id };}, methods: { checkstat: function checkstat() {var logininfo = _util.default.checklogin();this.openid = logininfo.openid;this.userinfo = logininfo.userinfo;this.token = logininfo.token;}, checklogin: function checklogin() {if (!this.token) {this.showlogin = true;return false;}return true;}, send: function send(e) {if (!this.checklogin()) {return false;}if (!this.text) {uni.showToast({ title: '请输入评论内容', icon: 'none' });return false;}var self = this;self.replylist.unshift({ text: this.text, avatar: this.userinfo.avatarUrl, nickName: this.userinfo.nickName, pubtime: '刚刚' });uni.request({ url: _util.default.apiurl + 'syj/index/setpinglun', method: 'POST', data: { text: self.text, id: self.id, token: self.token, shebei: _util.default.shebei }, success: function success(ret) {if (ret.statusCode == 200 && ret.data.code < 1) {self.text = '';uni.showToast({ title: '审核后显示' });setTimeout(function () {uni.hideLoading();}, 1000);} else {uni.showToast({ title: ret.data.msg, icon: 'none' });setTimeout(function () {uni.hideLoading();}, 1000);}},
        fail: function fail() {
          uni.hideLoading();
        },
    ...
    setlike: function setlike(type, index, tid) {
      _util.default.setlike(this, this.data, type, tid);
    },
    ...
    getData: function getData(id) {
      ...
      // 获取评论
      uni.request({
        url: _util.default.apiurl + 'syj/index/getpinglun',
        method: 'POST',
        dataType: 'json',
        data: {
...
/***/ 80:
/*!******************************************************************************************!*\
  !*** D:/workspace/物业服务前台V1.0.0/pages/detail/detail.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
